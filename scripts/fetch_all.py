...
SCHEDULE = [
    ...
    ('FRED Energy',      'fred_energy',     fred_energy.fetch,      720),   # 12h
    ('EIA Petroleum',    'eia_petroleum',   eia_petroleum.fetch,    720),   # 12h
    ('Energy Futures',   'energy_futures',  energy_futures.fetch,   360),   # 6h
    ('Eurostat Oil',     'eurostat_oil',    eurostat_oil.fetch,     1440),  # 24h
...
def main() -> int:
    ...
    print(f'=== Energy Dashboard fetch v5.1 — {store.now_iso()} ===')
    if args.force:
